            ...
            <div class="form__group">
                ...
                <div class="form__group-content">
                    <div class="form__input-radio">
                        <input type="radio" class="form__input-radio-item" id="male" name="gender" value="male"
                            {{ old('gender') == 'male' ? 'checked' : '' }} checked />
                        <label for="male">男性</label>
                        <input type="radio" class="form__input-radio-item" id="female" name="gender" value="female"
